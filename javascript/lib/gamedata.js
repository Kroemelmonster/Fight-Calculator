...
const ATTACKER_EXP_WIN_FAKTOR 			= [5000,2000,5000];
const ATTACKER_EXP_LOOSE_FAKTOR 		= [200000,200000,200000];
const DEFENDER_EXP_WIN_FAKTOR 			= [20000,20000,20000];
const DEFENDER_EXP_LOOSE_FAKTOR 		= [333333,333333,333333];

const ATTACKER_MONST_EXP_WIN_FAKTOR 	= [2500,5000,2500];
const ATTACKER_MONST_EXP_LOOSE_FAKTOR 	= [100000,50000,100000];
const DEFENDER_MONST_EXP_WIN_FAKTOR		= [10000,50000,10000];
const DEFENDER_MONST_EXP_LOOSE_FAKTOR	= [166666,833333,166666];

const ATTACKER_GATE_EXP_WIN_FAKTOR 		= [1000000,2000000,1000000];
const ATTACKER_GATE_EXP_LOOSE_FAKTOR 	= [40000000,200000000,40000000];

const WARPOINTS_FAKTOR 					= 500000;

const TREASURYFAKTOR = [[100,90,80,70,60,50,40,30],[100,95,90,85,80,75,70,65],[100,90,80,70,60,50,40,30]];
...
const RACEUNIT = [
	...
	[100,160,200],
	[100,160,200]];
const SERVEROKOARCHER = [{ Ranking: [490,100], Lohn: 0.4, Attack: [15,25], Hp: 10, Special : 100 },{ Ranking: [740,100], Lohn: 0.7, Attack: [20,30], Hp: 15, Special : 100 },{ Ranking: [1013,10], Lohn: 0.9, Attack: [30,40], Hp: 20, Special : 100 }];
