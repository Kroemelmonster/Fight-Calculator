const RACE_NAMES = ["Knight", "Lightelf", "Demon", "Drow", "Monster","Clancastel"];
const TERRAIN_NAMES = ["Holyland","Magic Forest","Deadland","Cursed forest","Mountains","Desert","Forest","Steppe","Dungeon"];
const GENERAL = {
	TITLE : 		"Calculator", 
	ATTACKER : 		"Attacker", 
	DEFENDER : 		"Defender", 
	SQUAD : 		"Army", 
	ADD_SQUAD : 	"Add Army",
	RANKING :		"Army strength",
	FRACTION : 		"Faction loyalty",
	EXP :			"Experiance",
	WARPOINT :		"War Points",
	COST :			"Salary",
	CHANCE : 		["min","norm","max"],
	...
	ROUND : 		"Round",
	ROUNDTERROR :	"Horror Round",
	ROUNDDEATH :	"Death Round",
	ROUNDHEAL : 	"Healing Round",
	ROUNDGATE : 	"Gate Round",
	ROUNDNECRO : 	"Necromancy Round",
	NOTHING : 		"nothing",
	TOWER :			"Tower",
	MTOWER : 		"Magic Tower",
	FORT : 			"Fort",
...
const RESULT_END = " does win";
const SAVE_BOX = {
	CODE : 'Code',
	SAVE_NAME : 'Save as Cookie',
	SAVE : 'Save',
	LINK : '',
	LOAD_CODE : 'load Code',
	LOAD_NAME : 'load from Cookie',
	LOAD : 'load',
}
const TOOLTIP = {
	BAD : "Renegade",
...
const EFFECTTYPE = [
	...
	"Hitpoints", // hp 
	"Defence", // defend
	"Maxdefence", // maxdefend
	"Victimattack", // victim
	"Healerpower", // healerpower  5
	"Magepower", // magepower
	"Payload",	// carrier
	"Attack for each round", // roundattack
	"Army attack value", // armydamage
	"Attack Value for each round", // damage 10
	"Death in the Fortification round", // fortdeath
	"Looses at Fortification", // fort
	"Tower attack value", // tower
	"Magictower attack value", // mtower
	"Defence of the Gate", // gate,
	"Magedefence", // magicdefned 15
	"Necromancy", // necro
	"Horror", // terror
	"Kill wounded", // death
	"Catapult", // catapult
...
const EFFECTUNIT = [
	"every unit",
	"Warrior, Rider, Flyer and Archer",
	"Carrier",
	"Warrior",
	"Rider",
	"Flyer",
...
var EFFECTRACE = ["Raceindependent",
	RACE_NAMES[0],
	RACE_NAMES[1],
	RACE_NAMES[2],
	RACE_NAMES[3],
	...
	RACE_NAMES[5],
	"Fraction"];
const HEROCLASS = ["No Hero selected","Governor","Wizard","Strategist"];
const MONSTHEROCLASS = ["Aggrohero","Stonehedge","Big Boss"];
const MONSTHEROTYPE = ["Juggernaut","Hexer","Juggernaut-Archi","Uralter"];
const HEROTYPE = [
	["Builder","Defender","Guru","Miner","Trader"],
	["Necromancer","Healer","Illusionist","Whisperer","Diffuser"],
	["Paladin","Peacemaker","Saboteur","Scout","Warrior"]];
function effect2Textinner(effect,lvl){
	...
	if(effect.loc != EL.EVERYWHERE) {
		text += " on Terrain "+EFFECTLOCATION[effect.loc];
	}
